            ...
            >
                <View style={styles.content}>
                    ...
                    <Animated.View entering={FadeInDown.delay(200)} style={styles.header}>
                        ...
                        <ThemedText style={[styles.subtitle, { color: secondaryText }]}>Sign in to continue your journey</ThemedText>
                    </Animated.View>
                    ...
                    <Animated.View entering={FadeInDown.delay(400)} style={styles.form}>
                        ...
                        >
                            <ThemedText style={[styles.linkText, { color: secondaryText }]}>
                                New here? <ThemedText style={{ color: tintColor, fontWeight: '700' }}>Create Account</ThemedText>
                            </ThemedText>
                        </TouchableOpacity>
                    </Animated.View>
                </View>
